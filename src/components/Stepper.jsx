...
const createArrays = (steps, bendings) => {
  const arrays = [];
  let startIndex = 0;
...
const Stepper = ({
  ...
  //     large: "4.5rem",
  //   };
  //   const iconSize = sizes[${stepsSize}];
              ...
              <Fragment key={index}>
                ...
                {index !== array.length - 1 && (
                  <motion.div
                    ...
                    className={`${
                      vertical === true
                        ? `w-[5px] flex justify-center  my-1 items-center h-[100px] ${
                            stepsSize === "small"
                              ? "ml-5"
                              : stepsSize === "medium"
                              ? "ml-7"
          ...
          {arrayIndex < finalArray.length - 1 && bendings[0] !== -1 && (
            ...
            >
              <div
                className={` flex ${
                  vertical === true
                    ? `w-full flex=1 flex-col items-center  justify-${
                        arrayIndex % 2 === 0
                          ? `end  ${
                              stepsSize === "small"
                                ? "mb-3"
